...
def create_gpf_file(npts, center, receptor_types, receptor_file, output_file='protein.gpf'):
    ...
    grid_str = ("npts {npts}\n"                       
                ...
                "gridcenter {center}\n"
                "smooth 0.5\n"
                "map {path}/{name}_OA.map\n"
                "map {path}/{name}_OD.map\n"
                "elecmap {path}/{name}_e.map\n"
                "dsolvmap {path}/{name}_d.map\n"
                "dielectric -0.1465\n"
                "nbp_r_eps 2.8 5.000 12 10 OD OA\n"
                "nbp_r_eps 2.8 5.000 12 10 OD OS\n"
                "nbp_r_eps 2.8 5.000 12 10 OD NA\n"
                "nbp_r_eps 2.8 5.000 12 10 OD NS\n"
                "nbp_r_eps 2.8 5.000 12 10 OD SA\n"
               )
